...
Este guia foi feito pelo core maintainer [@Yan-Thomas](https://github.com/Yan-Thomas) para auxiliar contribuidores dessa tradução. Sinta-se livre para se juntar a nós nosso [grupo do Discord](https://discord.gg/dwQx2w9Tgm) para fazer perguntas, sugestões, etc.
