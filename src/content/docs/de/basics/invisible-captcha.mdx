...
## Ein Widget unsichtbar machen

`data-size="invisible"` macht das Widget unsichtbar. Setzen Sie es auf das Element, das das Formular absendet:
...
Welche Herausforderung dahinter läuft, ist eine Eigenschaft des Site Keys und wird im
[Prosopo Portal](https://portal.prosopo.io) festgelegt — siehe [CAPTCHA-Typen](/de/basics/captcha-types/). Bei einem
`frictionless`-Site-Key lösen die meisten Besucher einen unsichtbaren Proof of Work und sehen nie etwas; einem als
riskant bewerteten Besucher wird beim Absenden ein Puzzle oder eine Bild-Herausforderung gezeigt.
