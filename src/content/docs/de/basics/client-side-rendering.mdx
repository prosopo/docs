...
Hier gibt es keinen CAPTCHA-Typ zu setzen. Welche Herausforderung ein Besucher erhält, ist eine Eigenschaft des Site
Keys und wird im [Prosopo Portal](https://portal.prosopo.io) festgelegt; dem Widget wird beim Sitzungsstart mitgeteilt,
welche es ausführen soll. Siehe [CAPTCHA-Typen](/de/basics/captcha-types/).
