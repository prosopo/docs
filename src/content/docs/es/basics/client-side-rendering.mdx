...
Aquí no hay ningún tipo de CAPTCHA que configurar. El desafío que recibe un visitante es una propiedad de la clave del
sitio, elegida en el [portal de Prosopo](https://portal.prosopo.io), y el servidor le indica al widget cuál ejecutar al
iniciar la sesión. Consulte [Tipos de CAPTCHA](/es/basics/captcha-types/).
