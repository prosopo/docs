...
## Hacer invisible un widget

`data-size="invisible"` es lo que hace invisible el widget. Colóquelo en el elemento que envía el formulario:
...
Qué desafío se ejecuta detrás es una propiedad de la clave del sitio, elegida en el
[portal de Prosopo](https://portal.prosopo.io) — consulte [Tipos de CAPTCHA](/es/basics/captcha-types/). Con una clave
`frictionless`, la mayoría de los visitantes completan un Proof of Work invisible y nunca ven nada; a un visitante con
puntuación de riesgo se le muestra un puzle o un desafío de imagen al enviar.
