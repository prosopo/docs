...
The threshold lives on the **CAPTCHA Type** card in Site Settings, and only applies when the type is
`frictionless`:

<Image src={CaptchaTypeSettings} alt="prosopo CAPTCHA type and safety threshold settings" style="margin: 20px auto;"/>
