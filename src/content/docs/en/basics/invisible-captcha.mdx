...
Invisible mode is enabled by setting `data-size="invisible"` (or `size: "invisible"` when rendering explicitly). The
captcha type served (`frictionless`, `pow`, or `image`) is determined by your site key's configuration in the
[portal](https://portal.prosopo.io), not by the client.
...
<body>
    ...
    <script type="module">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            widgetId = render(document.getElementById('procaptcha'), {
