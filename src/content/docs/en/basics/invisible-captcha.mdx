...
<Badge variant="caution">Beta Feature</Badge>
<Badge variant="tip">Pro & Enterprise Only</Badge>

Invisible Procaptcha provides seamless bot protection without interrupting the user experience. The CAPTCHA challenge runs in the background and only presents a visible challenge if additional verification is needed.
