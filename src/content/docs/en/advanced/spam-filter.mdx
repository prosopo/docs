...
import SpamFilter from '~/assets/spam-filter.png';
...
The card is on the **Email Filter** tab of Site Settings:

<Image src={SpamFilter} alt="prosopo email filter settings" style="margin: 20px auto;"/>
