...
Il n'y a pas de type de CAPTCHA à définir ici. Le défi qu'un visiteur reçoit est une propriété de la clé de site,
choisie dans le [portail Prosopo](https://portal.prosopo.io), et le serveur indique au widget lequel exécuter au
démarrage de la session. Voir [Types de CAPTCHA](/fr/basics/captcha-types/).
