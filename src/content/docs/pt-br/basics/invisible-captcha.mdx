...
## Tornando um widget invisível

`data-size="invisible"` é o que torna o widget invisível. Coloque-o no elemento que envia o formulário:
...
Qual desafio roda por trás é uma propriedade da chave do site, escolhida no
[portal da Prosopo](https://portal.prosopo.io) — veja [Tipos de CAPTCHA](/pt-br/basics/captcha-types/). Com uma chave
`frictionless`, a maioria dos visitantes conclui um Proof of Work invisível e nunca vê nada; um visitante avaliado como
suspeito recebe um quebra-cabeça ou um desafio de imagem no momento do envio.
