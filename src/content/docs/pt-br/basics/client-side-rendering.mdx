...
Não há tipo de CAPTCHA a definir aqui. O desafio que um visitante recebe é uma propriedade da chave do site, escolhida no
[portal da Prosopo](https://portal.prosopo.io), e o servidor informa ao widget qual executar quando a sessão começa. Veja
