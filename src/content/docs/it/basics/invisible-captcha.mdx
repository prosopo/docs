...
## Rendere invisibile un widget

`data-size="invisible"` è ciò che rende invisibile il widget. Mettilo sull'elemento che invia il modulo:
...
Quale sfida venga eseguita dietro le quinte è una proprietà della chiave del sito, scelta nel
[portale Prosopo](https://portal.prosopo.io) — vedi [Tipi di CAPTCHA](/it/basics/captcha-types/). Con una chiave
`frictionless` la maggior parte dei visitatori completa un Proof of Work invisibile e non vede nulla; a un visitatore
valutato come rischioso viene mostrato un puzzle o una sfida con immagini al momento dell'invio.
