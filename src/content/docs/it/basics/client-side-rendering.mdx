...
Qui non c'è alcun tipo di CAPTCHA da impostare. La sfida che riceve un visitatore è una proprietà della chiave del sito,
scelta nel [portale Prosopo](https://portal.prosopo.io), e il server comunica al widget quale eseguire all'avvio della
sessione. Vedi [Tipi di CAPTCHA](/it/basics/captcha-types/).
